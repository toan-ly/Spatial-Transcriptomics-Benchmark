...
def main():
    ...
    for data_name in data_names:
        save_root = Path(f'/home/lytq/Spatial-Transcriptomics-Benchmark/Results/MERFISH/mHypothalamus/DeepST/{data_name}')
        ...
        adata = load_mHypothalamus(data_path, data_name)
        ...
        sc.pl.spatial(adata, color='DeepST_shift', ax=ax, show=False, spot_size=20)
